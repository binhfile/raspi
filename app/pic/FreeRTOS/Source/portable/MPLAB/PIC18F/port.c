 ...
 */
#if defined(__XC8__)
static void interrupt prvLowInterrupt( void );
#else
 ...
 */
#if defined(__XC8__)
#define	portSAVE_CONTEXT_portINTERRUPTS_UNCHANGED								\
{																				\
...
#define	portSAVE_CONTEXT_portGLOBAL_INTERRUPT_FLAG								\
{																				\
		/* Save the status and WREG registers first, as these will get modified	\
		by the operations below. */												\
		asm("MOVFF	WREG, PREINC1		");											\
...
#if defined(__XC8__)
    portSAVE_CONTEXT_portINTERRUPTS_UNCHANGED;
#else
...
#if defined(__XC8__)
    portSAVE_CONTEXT_portGLOBAL_INTERRUPT_FLAG;
#else
...
uint8_t ucByte;
    ...
    OpenTimer1( 0b11111111 & 0b11111101 & 0b11001111 & 0b10111111 );
